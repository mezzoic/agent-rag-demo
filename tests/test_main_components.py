...
class TestBaseRetriever:
    ...
    def test_abstract_methods_must_be_implemented(self):
        ...
        with pytest.raises(TypeError):
            BaseRetriever()  # Cannot instantiate abstract class
    ...
    def test_format_node_with_scores_simple(self):
        ...
        # Create mock results
        mock_node1 = Mock()
        mock_node1.metadata = {"name": "Alice Johnson"}
        mock_result1 = Mock()
        mock_result1.node = mock_node1

        mock_node2 = Mock()
        mock_node2.metadata = {"name": "Bob Smith"}
        mock_result2 = Mock()
        mock_result2.node = mock_node2

        results = [mock_result1, mock_result2]

        formatted = BaseRetriever.format_NodeWithScores(results, "simple")
        expected = "1. Alice Johnson\n2. Bob Smith"
